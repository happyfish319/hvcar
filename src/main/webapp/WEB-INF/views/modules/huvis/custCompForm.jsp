...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/huvis/custComp/list">收货方公司列表</a></li>
		<li class="active"><a href="${ctx}/huvis/custComp/form?id=${hvCustCompMst.id}">收货方公司${not empty hvCustCompMst.id?'修改':'添加'}</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hvCustCompMst" action="${ctx}/huvis/custComp/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<div class="control-group">
			<label class="control-label">公司名称：</label>
			<div class="controls">
				<form:input path="custCompNm" htmlEscape="false"  maxlength="50" class="input-xxlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="custCompId" htmlEscape="false"  maxlength="50" class="input-xxlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
